...
export default function Navbar() {
  ...
  return (
    <nav className="bg-background fixed w-full z-20 shadow-lg border ">
      <div className="w-full mx-auto transition animate-in slide-in-from-top-3 fade-in-15  duration-1000 px-4">
        <div className="flex justify-between transition animate-in slide-in-from-top-3 fade-in-15  duration-500 h-16 items-center">
          <div className="flex items-center  w-full content-between  justify-between">
            ...
            <div className="hidden md:flex items-center  justify-center w-full space-x-4">
              <Link
                to="/products"
                className="text-primary hover:text-blue-600 px-3 py-2"
              >
                Products
              </Link>
              <Link
